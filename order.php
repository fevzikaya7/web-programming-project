        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-10 col-lg-8 gy-3">
                ...
                <form method="post" class="row g-3">
                    ...
                    <div class="col-md-10">
                        <label for="inputAddress" class="form-label" id="deneme">Address</label>
                        <input type="text" class="form-control" name="address1" id="inputAddress" placeholder="1234 Main St" required>
                    </div>
                    <div class="col-md-10">
                        <label for="inputAddress2" class="form-label" id="deneme1">Address 2</label>
                    ...
                    <div class="col-lg-6 gy-2">
                        <select id="inputState1" name="tree" class="form-select">
                    ...
                    <div class="col-lg-8">
                        ...
                        Yes <input class="form-check-input" type="radio" name="flexRadioDefault" id="q11" value="1" onchange='sa(this.value);'> &emsp;
                        No <input class="form-check-input" type="radio" name="flexRadioDefault" id="q12" value="0" onchange='sa(this.value);' ><br>
                    ...
                    <div class="col-lg-2">
                        <select class="form-select" name="mounth">
