...
<html lang="tr">
<head>
    <title>Online Fidan Satış</title>
    <meta charset="UTF-8">
...
<body>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="foto/3.jpg" class="d-block w-100 yuk" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="foto/1.jpg" class="d-block w-100 yuk" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="foto/2.jpg" class="d-block w-100 yuk" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="foto/4.jpg" class="d-block w-100 yuk" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="foto/aksener.jpg" class="d-block w-100 yuk" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="foto/cumhurbaskani.jpg" class="d-block w-100 yuk" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="foto/kılıcdaroglu.jpg" class="d-block w-100 yuk" alt="...">
                        </div>
                    </div>
    ...
    <hr>
        ...
        <div class="row">
            <div class="col-12">
                <h2 style="font-family: Poppins, sans-serif;">Tree Species</h2>
            </div>
        </div>
    </div>     
    ...
    <div class="container">
    <div class="row">
        <div class="col-sm-12 col-lg-3 gy-3">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/sedir3.jpg" alt="">
                    <div class="info">
                        <h1>Cedar</h1>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Cedar Tree</h5>
        ...
        <div class="col-sm-12 col-lg-3 gy-3">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/ormangulu.jpg" alt="">
                    <div class="info">
                        <h2>Rhododendron</h2>
        ...
        <div class="col-sm-12 col-lg-3 gy-3">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/sıgla.jpg" alt="">
                    <div class="info">
                        <h1>Sweetgum</h1>
                        <p>The flowers typically appear in spring and persist into autumn/fall, sometimes persisting into winter. They are typically about 25–40 mm in diameter and are covered with rusty hairs.</p>
                    </div>
                </div>
        ...
        <div class="col-sm-12 col-lg-3 gy-3">
            <div class="wrapper">
                ...
                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal4">
                    Read More
                </button>
                ...
                <div class="modal fade" id="exampleModal4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel4">Oak Tree</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        <div class="modal-body">
    ...
    <hr>
    <div class="row">
        <div class="col-sm-12 col-lg-3 gy-4">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/almond.jpg" alt="">
                    <div class="info">
                        <h1>Almond</h1>
                        <p>The fruit of the almond is a drupe, consisting of an outer hull and a hard shell with the seed, which is not a true nut, inside.</p>
                    </div>
                </div>

                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal5">
                    Read More
                </button>
                ...
                <div class="modal fade" id="exampleModal5" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel5">Almond Tree</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        <div class="modal-body">
        ...
        <div class="col-sm-12 col-lg-3 gy-4">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/hackberry-tree.jpg" alt="">
                    <div class="info">
                        <h1>Hackberry</h1>
                        <p>The common hackberry is easily distinguished from elms and some other hackberries by its cork-like bark with wart-like protuberances.</p>
                ...
                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal6">
                    Read More
                </button>
                ...
                <div class="modal fade" id="exampleModal6" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel6">Hackberry Tree</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        <div class="modal-body">
        ...
        <div class="col-sm-12 col-lg-3 gy-4">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/weeping-willow.jpg" alt="">
                    <div class="info">
                        <h1>Willow</h1>
                ...
                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal7">
                    Read More
                </button>
                ...
                <div class="modal fade" id="exampleModal7" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel7">Weeping Willow Tree</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        <div class="modal-body">
        ...
        <div class="col-sm-12 col-lg-3 gy-4">
            <div class="wrapper">
                ...
                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal8">
                    Read More
                </button>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-3 gy-5">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/lemon-cypress.jpg" alt="">
                    <div class="info">
                        <h1>Cypress</h1>
                        <p>It is a very fast growing and very robust plant. Especially when the bright yellow green leaves are rubbed by hand, a lemon scent comes. It also creates a very nice appearance in the pot and can last for a long time.</p>
                    </div>
                </div>

                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal9">
                    Read More
                </button>
        ...
        <div class="col-sm-12 col-lg-3 gy-5">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/lemon.jpg" alt="">
                    <div class="info">
                        <h1>Lemon</h1>
                        <p>Lemon is a species that is usually grown in subtropical climatic regions of the northern and southern hemispheres. Lemons form medium-sized trees around 3-7 m. Trees exceeding 8 m. can also be encountered. Crown structures are scattered; As the tree matures, the crown structure reaches medium density.</p>
                    </div>
                </div>

                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal10">
                    Read More
                </button>
        ...
        <div class="col-sm-12 col-lg-3 gy-5">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/orange.jpg" alt="">
                    <div class="info">
                        <h1>Orange</h1>
                        <p>The orange tree is an evergreen tree with a yield of 50-60 years. Some well-maintained orange trees can live for 100 years or more. The orange plant belongs to the Rutaceae family. It is a flowering tree and its height at maturity can range from 5 to 15 m.</p>
                    </div>
                </div>

                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal11">
                    Read More
                </button>
                ...
                <div class="modal fade" id="exampleModal11" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel11">Orange Tree</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        <div class="modal-body">
        ...
        <div class="col-sm-12 col-lg-3 gy-5">
            <div class="wrapper">
                <div class="cardd">
                    <img src="foto/olive.jpeg" alt="">
                    <div class="info">
                        <h1>Olive</h1>
                        <p>Olive tree leaves are dark on the upper side and silver on the lower side. - The trunk of the olive tree is between 50-55 cm on average. In addition, its body is very resistant to decay and impacts. The olive tree is a very long-lasting and durable tree.</p>
                    </div>
                </div>

                <!-- Button trigger modal -->
                <br>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal12">
                    Read More
                </button>
